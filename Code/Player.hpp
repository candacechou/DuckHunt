...
public:
     ...
     */
    Player();
    int birdID(Bird bird);
    std::pair<double,int> getProbfromSpecies(Bird bird,int GuessSpecies);

    //int GuessBirdSpecies(const GameState &pState, const Deadline &pDue, const Bird &birds);
    /**
     * Shoot!
     *
